...
for d in date_l:
    ...
    pattern = rf"^/proj/ie/proj/Wellcome-ZEAS/RemoteSensing/DATA/Sentinel-5P/L2/OFFL/S5P_OFFL_L2__NO2____{time_stamp}T\d{{6}}_\d{{8}}T\d{{6}}_\d+_\d{{2}}_\d{{6}}_\d{{8}}T\d{{6}}/S5P_OFFL_L2__NO2____\d{{8}}T\d{{6}}_\d{{8}}T\d{{6}}_\d+_\d{{2}}_\d{{6}}_\d{{8}}T\d{{6}}\.nc$"
    print(pattern)
    ...
    out = f"/proj/ie/proj/Wellcome-ZEAS/RemoteSensing/DATA/Sentinel-5P/L3/OFFL/S5P_TROPOMI_NO2_L3_{time_stamp}_SPR_{SR_string}DEG_NOF_{number_of_files}.nc"
